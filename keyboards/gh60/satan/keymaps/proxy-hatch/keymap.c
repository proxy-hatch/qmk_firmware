 ...
 */
  [BASE_LAYER] = LAYOUT_60_ansi(
    ...
    KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             MO(FUNCTIONS), KC_LEFT, KC_DOWN, KC_RGHT
  ),
...
/* Overlay 1: Mouse/Func mode
  ...
  [FUNCTIONS] = LAYOUT_60_ansi(
    ...
    _______,          _______, _______, KC_CALC, _______, _______, _______, _______, _______, _______, _______,          KC_PGUP, \
